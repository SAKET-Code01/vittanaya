...
export default function OnboardingFlow({
  ...
  const handleCompleteNewIdea = (newIdeaData) => {
    const workspace = buildAdaptiveWorkspace({
      ...
      project_cost: Number(newIdeaData.project_cost || newIdeaData.projectCost || 0),
      projectCost: Number(newIdeaData.project_cost || newIdeaData.projectCost || 0),
      estimatedProjectCost: Number(newIdeaData.project_cost || newIdeaData.projectCost || 0),
